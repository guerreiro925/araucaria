                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Alterar Fornecedor</b></h4>
...
<?php
					...
					$consulta = mysql_query("SELECT * FROM fornecedores WHERE idFornecedor = '$idFornecedor' AND deletar != 1");
					while ($dados = mysql_fetch_array($consulta))
					
					{

?>       
									<form action="alterar_fornecedores.php" enctype="multipart/form-data" method="post" data-parsley-validate novalidate>
									
										<div class="">
											<div class="">
											  <input id="id" value="<?php echo $idFornecedor;?>" name="idFornecedor"  hidden="hidden" >
											</div>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" required parsley-type="change" name="link" value="<?php echo $dados['link'];?>" required placeholder="Preencha um link.." class="form-control" >
										</div>
