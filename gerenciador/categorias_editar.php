                            ...
                            <div class="col-lg-6">
								<div class="card-box">
                                    ...
                                    <?php
                    					...
                    					$consulta = mysql_query("SELECT * FROM categorias WHERE idCategoria = '$idCategoria' AND deletar != 1");
                    					while ($dados = mysql_fetch_array($consulta))
                    					
                    					{

                                    ?>       
									<form action="alterar_categorias.php" method="post" data-parsley-validate novalidate>
										...
										<div class="form-group">
											...
											<input type="text" name="titulo" value="<?php echo $dados['titulo'];?>" parsley-trigger="change" required placeholder="Preencha um título.." class="form-control" id="titulo">
										</div>
										
										<div class="form-group text-center m-b-0">
											<input name="submit" id="send" class="btn btn-primary " value="Alterar" type="submit">
											<button type="reset" class="btn btn-default  m-l-5" onClick="window.location.href='categorias.php'">
												Voltar
											</button>
										</div>
