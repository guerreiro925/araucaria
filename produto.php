...
<html>
<head>
        <title>Araucária Acabamentos &copy; | Produto</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-30">
                            <div class="mod-breadcrumbs font-alt align-right">
                                <div style="color: #FFF !important;"><a href="index.php" style="color: #fff !important">Home&nbsp;</a>/&nbsp;<a href="loja.php" style="color: #fff !important">Loja&nbsp;</a>/&nbsp;<span>Produto</span></div>
                            </div>
                            ...
                            ?>
                                ...
                                <div class="loja-responsive col-md-3 col-lg-3 mb-60 mb-xs-40">
                                    ...
                                    <div class="post-prev-more align-center">
                                        ...
                                        <a class="button-product" href="produto.php?idProduto=<?php echo $idProduto; ?>"><i class="fa fa-eye"></i> Ver Produto</a>
                                    </div>
