                ...
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist scroll-nav local-scroll">
                            ...
                            <li>
                                <a href="#promocao"  class="mn-has-sub">Promoção </a>
                            </li>
                            <li>
...
Produtos de extrema qualidade e totalmente adequados às normas brasileiras. O melhor piso vinílico, opção perfeita para ambientes novos ou mesmo onde haja piso laminado, de madeira ou porcelanato. Somos pioneiros no forro de PVC especial, produto com altíssimo padrão de acabamento, também voltado a novos espaços ou para a substituição de forro de gesso, de madeira, de PVC tradicional entre outros. 
            ...
            <section class="page-section bg-dark bg-dark-alfa-70 fullwidth-slider" id="promocao" data-background="assets/img/laminados.jpg">            
               
                <!-- Slide Item -->
                
                <?php 
                $consultaPromocao = mysql_query("SELECT * FROM produtos WHERE deletar != '1' AND status != 'inativo' AND promocao != '0'");
                  ...
                  while($dadosPromocao = mysql_fetch_array($consultaPromocao)){
                    ...
                    $idCategoria = $dadosPromocao['idCategoria'];
                    ...
                    <div class="container relative">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 align-center">
                                <h3 class=" font-alt" style="margin-top: 0px; margin-bottom:0px;"><?php echo $dadosPromocao['titulo'];?></h3>

                                <!-- Section Icon -->
                                <div class="post-prev-img">

                                  <a href="produto.php?idProduto=<?php echo $idProduto;?>">
                                  <?php 
                                  $consultaImages = mysql_query("SELECT * FROM produtos_images WHERE idProduto = '$idProduto' AND deletar != '1' LIMIT 1");
                                  while($dadosImages = mysql_fetch_array($consultaImages)){
                                    $imagem = $dadosImages['imagem'];
                                  ?>
                                    <img id="img-produto" src="gerenciador/<?php echo $imagem; ?>" alt="Loja - Araucária Acabamentos" />
                                  <?php } ?>
                                  
                                  </a>
                                  <div class="intro-label">
                                    <span class="label label-danger">
                                      <?php $consultaCategoria = mysql_query("SELECT * FROM categorias WHERE deletar != '1' AND status != 'inativo' AND idCategoria = '$idCategoria'"); 
                                      while ($dadosCategoria = mysql_fetch_array($consultaCategoria)){ 
                                        $categoria = $dadosCategoria['titulo'];
                                        if(strlen($categoria) >= 25){
                                          echo substr($categoria, 0, 25)."...";
                                ...
                                <blockquote class="testimonial white">
                                    <div class="mb-10">
                                        <a href="produto.php?idProduto=<?php echo $idProduto;?>" target="_blank" class="btn btn-mod btn-border btn-circle btn-large"><i class="fa fa-eye"></i> Ver Produto</a>
                                    </div>
                                </blockquote>
                            </div>
                        </div>
                  ...
                  <?php } else { ?>
                    <div>
                      <div class="container relative">
                        <div class="row">
                          <div class="col-md-8 col-md-offset-2 align-center">
                            <h3 class="font-alt">No momento não possui nenhum produto em promoção, verifique nossos outros produtos!</h3>
                            <a href="loja.php" target="_blank" class="btn btn-mod btn-border btn-circle btn-large">
                              <i class="fa fa-eye"></i> Visualizar todos os Produtos
                            </a>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-12 mb-sm-40">
                            <div class="row">
                                <div class="col-sm-6 col-lg-6 pt-20 pb-20 pb-xs-0">
                                    ...
                                    <?php 
                                    $consultaRedesSociais = mysql_query("SELECT * FROM redes_sociais");
                                    while ($dadosRedesSociais = mysql_fetch_array($consultaRedesSociais)){
                                    $facebook = $dadosRedesSociais['facebook'];
                                    $instagram = $dadosRedesSociais['instagram'];
                                    $twitter = $dadosRedesSociais['twitter'];

                                    ?>
                                    <?php if(empty($facebook)&&empty($twitter)&&empty($instagram)){?>
                                      <h2 class=" font-alt mb-20 mb-sm-10" style="font-family: 'alegreya_sansmedium';">
                                        Não há redes sociais ativa no momento.
                                      </h2>                                    
                                    <?php } else { ?>
                                    <h2 class=" font-alt mb-20 mb-sm-10" style="font-family: 'alegreya_sansmedium';">
                                        Redes Sociais
                                    ...
                                    <div class="contact-item padding-left mb-40">
