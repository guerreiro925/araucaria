                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-30">
                            <div class="mod-breadcrumbs font-alt align-right">
                                <div style="color: #FFF !important;"><a href="index.php" style="color: #fff !important">Home&nbsp;/&nbsp;</a>Loja&nbsp;</div>
                            </div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="row multi-columns-row">
								...
								<div class="col-md-4 col-lg-4 mb-60 mb-xs-40">
                                    ...
                                    <div class="post-prev-more align-center">
                                        <a href="produto.php?idProduto=<?php echo $idProduto; ?>" style="padding-top: 7px;" class="btn btn-mod btn-round  btn-small"><i class="fa fa-eye"></i> Ver Produto</a>
                                    </div>
                            ...
                            <div class="pagination">
                                <?php
                                  ...
                                  $proximo = $pc +1;
                                  if ($pc>1) {
                                  echo '<a style="background-color: #111; color: #fff;" href="loja.php?pagina='.$anterior.'"><i class="fa fa-angle-left"></i></a></li>';
                                  }
                                ?>
                                ...
                                <?php
                                    if ($pc<$tp) {
                                      echo '<a style="background-color: #111; color: #fff;" href="loja.php?pagina='.$proximo.'"><i class="fa fa-angle-right"></i></a>';
                                    } 
                                ?>
                            </div>
                            <!-- End Pagination -->
