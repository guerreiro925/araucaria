...
Produtos de extrema qualidade e totalmente adequados às normas brasileiras. O melhor piso vinílico, opção perfeita para ambientes novos ou mesmo onde haja piso laminado, de madeira ou porcelanato. Somos pioneiros no forro de PVC especial, produto com altíssimo padrão de acabamento, também voltado a novos espaços ou para a substituição de forro de gesso, de madeira, de PVC tradicional entre outros. 
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 align-center">
                                ...
                                <blockquote class="testimonial white">
                                    ...
                                    <div class="mb-10">
                                        <a style="padding-top: 14px;" href="http://simulador.eucatex.mediagroup.com.br/" target="_blank" class="btn btn-mod btn-border btn-circle btn-large">Simulador</a>
                                    </div>
                                </blockquote>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 align-center">
                                ...
                                <blockquote class="testimonial white">
                                    ...
                                    <div class="mb-10">
                                        <a style="padding-top: 14px;" href="http://www.suvinil.com.br/SimuladorV2/" target="_blank" class="btn btn-mod btn-border btn-circle btn-large">Simulador</a>
                                    </div>
                                </blockquote>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 align-center">
                                ...
                                <blockquote class="testimonial white">
                                    ...
                                    <div class="mb-10">
                                        <a style="padding-top: 14px;" href="http://www.tigre.com.br/pt/simuladores_2011.php" target="_blank" class="btn btn-mod btn-border btn-circle btn-large">Simulador</a>
                                    </div>
                                </blockquote>
                            </div>
                        </div>
                ...
                <div class="container relative">
                    ...
                    <div class="align-center">
                        ...
                        <div class="local-scroll">
                            <a href="loja.php" style="padding-top: 11px;" class="btn btn-mod btn-w btn-medium btn-round">Clique aqui</a>
                        </div>
                    </div>
                    ...
                    ?>
						<div class="blog-responsive col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="1s" style="text-align: center">
                            ...
                            <div class="post-prev-more">
                                <a style="padding-top: 6px;" href="noticia.php?idBlog=<?php echo $idBlog; ?>" class="btn btn-mod btn-gray btn-round">Continuar lendo <i class="fa fa-angle-right"></i></a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-6 pt-20 pb-20 pb-xs-0">
                                    ...
                                    <div class="contact-item padding-left">
                                        ...
                                        <h5 class=" font-alt mb-20 mb-sm-40" style="text-transform: lowercase; font-family: 'Gill Sans MT Pro Book'; font-size: 16px; line-height: 28px;">
                                    ...
                                    <div class="contact-item padding-left">
                                        <h4 class="mb-20 mb-sm-40" style="font-weight: normal; font-family: 'Gill Sans MT Pro Book'; font-size: 16px; line-height: 28px;">                                        
                                            (43) 3015 - 7500<br>
                                            (43) 3402 - 7865
                                        </h4>
                                ...
                                <div class="col-sm-5 col-lg-5 col-lg-offset-1 pt-20 pb-20 pb-xs-0">
                                    ...
                                    ?>
                                        ...
                                        <form method="post" action="envioemail.php" id="form" role="form" class="form">
                                            ...
                                            <div class="mb-20 mb-md-12">
                                                <input style="padding-top: 12px;" type="submit" name="submit" class="btn btn-mod btn-large btn-round" value="Enviar">
                                            </div>
            ...
            <section class="page-section pt-0 pb-0" id="localizacao" onclick="activeMap()" >
