                        ...
                        <div class="col-sm-8">
                            ...
                            ?>
    							...
    							<div class="blog-item-body">
                                    ...
                                    <h1 class="mt-0 font-alt" style="font-family: 'Gill Sans MT Pro Bold'; font-size: 19px; color: #777"><?php echo $dados['titulo'];?></h1>
                                    ...
                                    <div class="blog-media mt-40 mb-40 mb-xs-30">
                                        <ul class="clearlist content-slider">
                                            ...
                                            <li>
                                                ...
                                                <img style="max-width: 750px; width: 750px; height: 405px; max-height: 405px" src="gerenciador/<?php echo $dadosImage['imagem'];?>" alt="" />
    								...
    								<div style="font-family: 'Gill Sans MT Pro'; color: rgb(104, 105, 109);">
										<p>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    ?>
                                        ...
                                        <?php } ?> 
                                            <div class="widget-posts-descr" style="font-weight: bold; font-family: 'Gill Sans MT Pro'; color: rgb(104, 105, 109);">
