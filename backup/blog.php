...
<!-- Mirrored from rhythm.bestlooker.pro/blog-classic-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2017 18:14:44 GMT -->
                                        ...
                                        <div class="mn-wrap">
                                            <form method="post" action="buscar.php" class="form">
                                                <div class="search-wrap">
                                                    ...
                                                    <input type="text" class="form-control search-field" placeholder="Pesquisar...">
                                                </div>
                                            </form>
                                        </div>
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="blog-item">
                                ...
                                <!-- Date -->
                                <div class="blog-item-date" style="font-family: 'Gill Sans MT Pro'">
 ...
 <span><?php echo strftime("%y", strtotime($date));?></span></span>
                                ...
                                <div class="blog-media">
                                    <ul class="clearlist content-slider">
                                        ...
                                        ?>    
                                        <li>
                                            <img style="max-height: 300px; height: 300px; width: 970px; max-width: 970px;" src="gerenciador/<?php echo $dadosImage['imagem'];?>" alt="" />
                                        </li>
                                        <?php } ?>
                                    </ul>
                                </div>
                                ...
                                <!-- Text Intro -->
								<div style="color: rgb(104, 105, 109); font-family: 'Gill Sans MT Pro'; font-weight: bold; font-size: 15px">
                                    <p>
                                ...
                                <div class="post-prev-more">
									<a style="padding-top: 6px; margin-bottom: 10px" href="noticia.php?idBlog=<?php echo $idBlog; ?>" class="btn btn-mod btn-gray btn-round">Continuar lendo <i class="fa fa-angle-right"></i></a>
								</div>
                            ...
                            <div class="pagination">
                                <?php
                                  ...
                                  $proximo = $pc +1;
                                  if ($pc>1) {
                                  echo '<a style="background-color: #111; color: #fff;" href="blog.php?pagina='.$anterior.'"><i class="fa fa-angle-left"></i></a></li>';
                                  }
                                ?>
                                ...
                                <?php
                                    if ($pc<$tp) {
                                      echo '<a style="background-color: #111; color: #fff;" href="blog.php?pagina='.$proximo.'"><i class="fa fa-angle-right"></i></a>';
                                    } 
                                ?>
                            </div>
                            <!-- End Pagination -->
